        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-2 grid grid-cols-2 gap-x-4 gap-y-1">
              ...
              {data.bookingRef && <Field label="Ref" value={data.bookingRef} wide />}
              {data.hotelName && <Field label="Hotel" value={data.hotelName} wide />}
              {data.checkIn && <Field label="Check-in" value={data.checkIn} />}
              {data.checkOut && <Field label="Check-out" value={data.checkOut} />}
              {data.roomType && <Field label="Room" value={data.roomType} wide />}
